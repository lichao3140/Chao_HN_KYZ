...
public class Const {
    ...
    public static final String KEY_FACE_RECOGNITION_TIME = "face_recognition_time";
     ...
     * 默认开启1比N
     */
    public static final boolean OPEN_ONE_VS_N = false;

    /**
     * 默认关闭1比1
     */
    public static final boolean OPEN_ONE_VS_ONE = true;
     ...
     * 单位秒  给定时间内同一个人不识别
     */
    public static final int FACE_RECOGNITION_TIME = 2;
    ...
    public static boolean RECON_SOCKET = true;
     ...
     * 服务器地址
     */
    private static String SERVER_IP = "http://123.13.201.131:8892/Ticket/";

    /**
     * 考勤终端注册接口
     */
    public static String QUERY_TICKET =  SERVER_IP + "queryBySfz?";
}

...
public class MySettingActivity extends FragmentActivity implements View.OnClickListener,
    ...
    private void initData() {
        ...
        //设置默认30天
        if (SPUtil.getInt(Const.KEY_PRESERVATION_DAY, 30) == 120) {
            Preservation_time.setSelection(0);
        } else if (SPUtil.getInt(Const.KEY_PRESERVATION_DAY, 30) == 90) {
            Preservation_time.setSelection(1);
        } else if (SPUtil.getInt(Const.KEY_PRESERVATION_DAY, 30) == 60) {
            Preservation_time.setSelection(2);
        } else if (SPUtil.getInt(Const.KEY_PRESERVATION_DAY, 30) == 30) {
            Preservation_time.setSelection(3);
        }
        //活体
